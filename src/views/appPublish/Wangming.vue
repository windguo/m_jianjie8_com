...
export default {
  ...
  mounted() {
    document.title = '发布网名';
    var that = this;
    this.axios.get("/wangming/?getJson=class").then(res => {
...
<style scoped>
.container{font-weight: 300;background:#ffffff}
.container h2{text-align: center;font-size: 0.4rem;padding:0.5rem 0 0 0;font-weight: 300;border-top: 10px solid #f5f5f5}
